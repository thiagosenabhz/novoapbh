...
const TITLE = "Reserva dos Buritis";
const SOLD_BADGE = "96% vendido";
const CONDITION_HEADLINE = "Unidades a partir de";
const CONDITION_PRICE = "R$ 410.000";
...
const GALLERY: { src: string; alt: string }[] = [
  ...
  { src: "/images/reserva-dos-buritis/007.jpg", alt: "Área comum 007" },
  { src: "/images/reserva-dos-buritis/008.jpg", alt: "Área comum 008" },
  { src: "/images/reserva-dos-buritis/009.jpg", alt: "Área comum 009" },
].filter(Boolean);
...
export default function ReservaDosBuritisPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-6">
      ...
      {/* HERO (corte padronizado com aspect ratio wide) + CONDIÇÕES */}
      <div className="grid gap-6 md:grid-cols-[1fr_360px]">
        <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white">
          <button type="button" aria-label="Abrir galeria de fotos" className="group relative block w-full" onClick={() => openGallery(0)}>
            {/* AQUI a mágica: container com aspect para recorte igual aos cards */}
      ...
      <WhatsAppButton variant="floating" text="Olá! Tenho interesse no Reserva dos Buritis." showCaption={false} iconSize={56} />
