...
/**
 * Modal genérico para captação de lead.
 * - Reaproveita o LeadForm;
 * - Ao enviar, dispara callback que pode redirecionar para o WhatsApp;
 * - Fecha com Esc e ao clicar no backdrop.
 */
    ...
    >
      ...
      >
        ...
        <LeadForm
          ...
          onSubmitted={() => {
            // Após submissão, direciona para o WhatsApp
            try {
